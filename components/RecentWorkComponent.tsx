        ...
        <div className="bg-black text-white py-16 px-8 md:px-16 lg:px-24">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mt-8 text-center">
                    <Link
                        href="/Work"
                        className="bg-green-200 text-black py-2 px-6 text-lg hover:bg-transparent hover:text-green-200 hover:border-green-200 border-2 transition duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white shadow-md hover:shadow-lg"
                    >
                        View All
                    </Link>
                </div>
